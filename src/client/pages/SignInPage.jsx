                ...
                <form onSubmit={handleSignin} className='flex  flex-col justify-center  items-center bg-white w-full  lg:h-full h-3/4 rounded-2xl p-5'>
                    ...
                    <div className='w-full  relative mt-4 lg:mt-0'>
                        <input type="text" required id="username" onChange={(e) => setUserName(e.target.value)}
                            className="peer lg:text-base w-full border-b border-gray-400 focus:outline-none focus:border-black bg-transparent pt-6 pb-2" placeholder=" " />
                        <label htmlFor="username" className="absolute lg:text-base left-0 top-2 text-gray-500 text-sm transition-all peer-placeholder-shown:top-6 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-focus:top-2 peer-focus:text-sm peer-focus:text-black">User Name</label>
                    </div>
                    <div className='w-full relative mt-4 lg:mt-0'>
                    ...
                    <div className='w-full relative mt-4 lg:mt-0'>
                        <input type="password" required id="confirmPassword" onChange={(e) => setConfirmPassword(e.target.value)}
                            className="peer w-full border-b border-gray-400 focus:outline-none focus:border-black bg-transparent pt-6 pb-2" placeholder=" " />
                        <label htmlFor="confirmPassword" className="absolute left-0 top-2 text-gray-500 text-sm transition-all peer-placeholder-shown:top-6 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-focus:top-2 peer-focus:text-sm peer-focus:text-black">conform password</label>
                    </div>

                    <button type='submit' className='flex w-full text-center  justify-center p-3 mt-10 rounded-xl bg-black hover:bg-neutral-900 cursor-pointer text-white font-semibold'>Sign In</button>

                    <Link to='/login' className='mt-8 text-neutral-500'>Already have an account ?</Link>
                </form>
